/* These are the imports for the function. */
...
function Upload() {
  ...
  /* The file content is displayed after the file is uploaded. */
  const fileData = () => {
    if (selectedFile) {
      return (
        <div>
      ...
      return (
        <div>
          <br />
          <h4>
            Choose before pressing the Upload button or else it will error
          </h4>
        </div>
      );
    }
